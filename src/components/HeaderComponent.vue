<template>
  <div class="header">
    <div class="menu" v-on:click="isClicked = !isClicked">
      <img
        src="https://img.icons8.com/external-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto/64/000000/external-menu-multimedia-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto-2.png"
      />
    </div>
    ...
    <div v-if="isClicked" class="menu-container">
      ...
      <div>
        ...
        <span>Find candidates around here</span>
      </div>
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <span>Find jobs around here</span>
      </div>
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"

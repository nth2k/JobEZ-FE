    ...
    <div class="s-from ct_tab active">
      <div class="tt_td">
        <div class="box_tomtat_2">
          ...
          <p>- Yêu cầu giới tính: <span>Nam</span></p>
          <p>- Số lượng cần tuyển: <span>3 ứng viên</span></p>
          <p>
            - Ngành nghề:
            <a
        ...
        <div class="box_mota">
          <div class="hd_mota">
            ...
            - Chuyên thi công lắp đặt hệ thống đường ống, đường điện, thiết bị
            bể bơi, xông hơi, đài phun nước theo bản vẽ và theo thực tế yêu
            cầu.<br />- Lắp đặt các sản phẩm thiết bị, máy móc công ty cung cấp.
            Hướng dẫn khách hàng cách sử dụng và vận hành máy móc sau khi lắp
        ...
        <div class="box_yeucau">
          ...
          - Nam; Tuổi từ 18 - 35<br />- Tốt nghiệp Trường đào tạo nghề trở lên,
          <br />- Kỹ năng giải quyết công việc cẩn thận, tỉ mỉ và nhanh chóng
          chính xác<br />- Hoàn thành công việc đúng tiến độ được giao<br />-
          Thực hiện đúng quy trình và nội quy của công ty <br />- Có khả năng
          làm việc độc lập hoặc theo nhóm.<br />- Có kiến thức chuyên môn về
          điện nước công trình hoặc nhà dân<br />- Biết nghề mộc là một lợi
          thế.<br />- Trung thực, trách nhiệm, chăm chỉ, nhiệt tình trong công
          việc. Có phong cách làm việc chuyên nghiệp.<br />
        </div>
        <div class="box_quyenloi">
          <h2 class="descibe">Quyền lợi được hưởng</h2>
          - Thu nhập: 8.000.000 – 15.000.000 triệu/ tháng <br />- Hỗ trợ chi phí
          ăn ở, đi lại khi công tác ngoại tỉnh;<br />- Cơ hội học hỏi, trau dồi
          kinh nghiệm, kiến thức, được cử đi đào tạo các khóa kỹ năng;<br />-
          Tháng lương 13, xét tăng lương 6 tháng/lần<br />- Nghỉ phép 12 ngày/
          năm <br />- Tham gia đầy đủ các chế độ BHXH,BHYT,BHTN..., các ngày
          nghỉ lễ tết... <br />- Tham gia các hoạt động nghỉ mát, gala,
          teambuilding<br />- Môi trường thân thiện, chuyên nghiệp, văn hóa
          doanh nghiệp 9 năm, quy mô &gt;100 nhân sự<br />
        </div>
        <div class="box_hoso">

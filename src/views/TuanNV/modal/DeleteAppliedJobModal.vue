    ...
    <v-card>
      ...
      <v-card-actions>
        ...
        <v-btn
          ...
          text
          @click="deleteAppliedJob(postingId, userId, recruiterId)"
        >
          Đồng ý
        </v-btn>
      </v-card-actions>
...
export default {
  name: "DeleteAppliedJobModal",
  props: ["postingId", "userId", "recruiterId"],
  data() {
    return {
      dialog: false,
    };
  ...
  methods: {
    deleteAppliedJob(postingId, userId, recruiterId) {

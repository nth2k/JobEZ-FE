          ...
          <div class="container">
            ...
            <div class="block">
              <span id="show" @click="showDetail">
                <i class="animate-icon fa fa-chevron-up" aria-hidden="true"></i><span class="ml-1">Tốt nghiệp Đại học</span>
              </span>
              ...
              <div class="detail container p-3 mt-2" id="detailInfo">
                <div>
                  <span class="font-weight-bold">Chuyên ngành: </span><span>Kỹ thuật phần mềm</span>
                </div>
                <div><span class="font-weight-bold">Tại: </span><span>Đại học FPT</span></div>
                <div><span class="font-weight-bold">Từ: </span><span>20/07/2015 - 30/08/2022 (4 năm)</span></div>
              </div>
            </div>
          </div>
        </div>

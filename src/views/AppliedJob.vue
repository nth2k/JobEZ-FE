<template>
  <div class="table-job">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="column"><button class="btn btn-danger btnDelete"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
		...
		<div class="update"><span>Hãy cập nhật thông tin về người tham chiếu hồ sơ của bạn để tăng chất lượng hồ sơ và thu hút nhà tuyển dụng <a href="#" class="text-danger">Cập nhật ngay</a></span></div>
	</div>
</template>
